...
// Add container markup only for WC notices
add_action( 'woocommerce_before_single_product', 'zn_wc_productpage_markup_before_single' );
function zn_wc_productpage_markup_before_single(){
	?>
			</div>
		</div>
	</div>
