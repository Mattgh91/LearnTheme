...
class ZnSection extends ZnElements {
	...
	function element() {
        ...
        ?>
		<section class="zn_section <?php echo implode(' ', $section_classes); ?>" id="<?php echo $uid; ?>" <?php echo $autopopup_attr; ?> <?php echo $attributes; ?>>
			...
			<div class="zn_section_size <?php echo $this->opt('size','container');?>">
